...
export default function BottomNavigation() { return <nav className="bottom-navigation">{links.map(([to, Icon]) => <NavLink key={to} to={to} onClick={() => document.body.classList.remove("nav-open")}><Icon /></NavLink>)}</nav>; }
