...
export default function Header() {
  ...
  return (
    <header className="global-header">
      <Link to="/home" className="brand" aria-label="Desire Link home">
        <span>👊</span>mbogi
      </Link>
      <SearchBar />
      ...
      <div className="header-actions">
        <Link className="create-button" to="/create-post">
        ...
        <div className="menu-anchor">
          ...
          <NotificationDropdown open={notifications} />
        </div>
        <ThemeToggle />
        <div className="menu-anchor">
          <button
          ...
          <UserMenu open={menu} onLogout={exit} />
        </div>
        <button
