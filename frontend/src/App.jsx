...
const AddUsersPage = lazy(() => import("./pages/home/card"));
...
const ExploreUsersPage = lazy(() => import("./pages/ExploreUsers"));
...
export default function App() {
  return <BrowserRouter><ThemeProvider><AuthProvider><BookmarkProvider><Toaster position="top-right" toastOptions={{ duration: 3500 }} />
    <Suspense fallback={<LoadingScreen />}><Routes>
      ...
      <Route element={<AuthLayout />}><Route path="/login" element={<LoginPage />} /><Route path="/signup" element={<RegisterPage />} /><Route path="/verify-email" element={<VerifyEmailPage />} /><Route path="/forgot-password" element={<ForgotPasswordPage />} /><Route path="/reset-password" element={<ResetPasswordPage />} /></Route>
      <Route element={<ProtectedLayout />}>
        ...
        <Route path="/create-post" element={<Lazy><CreatePostPage /></Lazy>} /><Route path="/add-users" element={<Lazy><AddUsersPage /></Lazy>} /><Route path="/people" element={<Lazy><ExploreUsersPage /></Lazy>} />
