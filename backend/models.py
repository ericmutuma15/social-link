...
class User(db.Model):
    ...
    # Optional binary storage for avatars and covers (new, behind a migration)
    avatar_data = db.Column(db.LargeBinary, nullable=True)
    avatar_mime = db.Column(db.String(120), nullable=True)
    cover_photo_data = db.Column(db.LargeBinary, nullable=True)
    cover_photo_mime = db.Column(db.String(120), nullable=True)
